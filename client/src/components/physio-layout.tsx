...
const navigation = [
  { name: 'Dashboard', href: '/physio', icon: LayoutDashboard },
  { name: 'My Schedule', href: '/physio/schedule', icon: Calendar },
  { name: 'Request Swap', href: '/physio/swap-requests', icon: RefreshCw },
  { name: 'Notifications', href: '/physio/notifications', icon: Bell },
  { name: 'Profile', href: '/physio/profile', icon: User },
  { name: 'Settings', href: '/physio/settings', icon: Settings },
];

export default function PhysioLayout({ children }: PhysioLayoutProps) {
